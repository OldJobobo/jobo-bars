...
|---|---|---|---|
| [omabar-v2](./omabar-v2/) | _No preview image in repo yet_ | A slim status bar with centered clock and media state, plus lightweight telemetry on the right. | `omabar-v2/config.jsonc`<br>`omabar-v2/style.css` |
...
- Start with `tilebar-v1/README.md` for usage details.
